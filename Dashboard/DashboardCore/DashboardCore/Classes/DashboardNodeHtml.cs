...
{
    public class DashboardNodeHtml : DashboardNode
    {
        #region Properties
        ...
        /// </param>
        public DashboardNodeHtml(Dashboard dashboard, XmlNode xmlNode)
        ...
        /// </param>
        public DashboardNodeHtml(Dashboard dashboard, XmlNode xmlNode, DashboardNode parent)
        ...
        private string ReplacePlaceholder(string source, DashboardRenderContext context)
        {
            ...
            /*while (source.Contains("###CATEGORYCOUNT_"))
            {
                string variableName = source.Split(new string[]
                {
                    "###CATEGORYCOUNT_"
